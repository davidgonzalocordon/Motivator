 ...
 * @author ASUS
 */
public class RegustrarRestaurante extends javax.swing.JFrame {

    /**
     * Creates new form RegustrarRestaurante
     */
    public RegustrarRestaurante() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(RegustrarRestaurante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegustrarRestaurante().setVisible(true);
            }
        });
    }
